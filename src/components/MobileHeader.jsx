        ...
        <>
            <nav className="flex items-center gap-6 px-6 md:px-8 lg:px-10 xl:px-12 pb-4 pt-[calc(env(safe-area-inset-top,0px)+1rem)] md:py-4 border-b border-gray-700/50 bg-gray-900/95 backdrop-blur-xl relative transition-all sticky top-0 z-50 md:ml-60 lg:ml-80 md:w-[calc(100%-15rem)] lg:w-[calc(100%-20rem)]">
                ...
                <Link to="/" className="flex items-center gap-3 flex-shrink-0">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg overflow-hidden bg-gradient-to-br from-green-600 to-green-500">
                        <img
                            src="/icon.png"
                            alt="Pneuma Logo"
                ...
                {/* Navigation Links - Desktop - Only show on medium screens and up */}
                <div className="hidden md:flex items-center justify-center gap-4 xl:gap-8 flex-1 min-w-0">
                    <a
                ...
                <div className="md:hidden flex items-center justify-center gap-3 flex-1 min-w-0">
                    <a
                        href="https://freedomexperienceministry.org/"
                        target="_blank"
                        rel="noreferrer"
                ...
                <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-gray-900 border-b border-gray-700/50 shadow-2xl py-4 flex-col items-start gap-2 px-5 text-sm lg:hidden z-50`}>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full px-3 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-gray-800/50 transition-colors"
